...
namespace CleanArchTemplate.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260415213406_AddAuthProvidersTable")]
    partial class AddAuthProvidersTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchTemplate.Domain.AuthProvider.AuthProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CleanArchTemplate.Domain.User.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.PrimitiveCollection<List<string>>("ResetPasswordCodes")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("CleanArchTemplate.Domain.AuthProvider.AuthProvider", b =>
                {
                    b.HasOne("CleanArchTemplate.Domain.User.User", "User")
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    ...
                    b.HasOne("CleanArchTemplate.Domain.User.User", null)
                        .WithMany()
